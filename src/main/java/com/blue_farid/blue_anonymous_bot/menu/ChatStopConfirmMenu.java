...
public class ChatStopConfirmMenu extends Menu {
    ...
    protected List<KeyboardRow> creatKeyBoard() {
        ...
        keyboardFirstRow.add(CommandConstant.CANCEL_CHAT_CONFIRM_YES);
        KeyboardRow keyboardSecondRow = new KeyboardRow();
        keyboardSecondRow.add(CommandConstant.CANCEL_CHAT_CONFIRM_NO);
